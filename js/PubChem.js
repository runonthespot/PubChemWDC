(function() {
    ...
    myConnector.getData = function(table, doneCallback) {
      ...
      var apiCall = 'https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/name/'+encodeURIComponent(table.tableInfo.description)+'/json?record_type=3d';  
        ...
        for (deg = 0; deg < 360; deg++)
        {
          for (i = 0; i < bonds.aid1.length; i++) {
            var entry = {
                          ...
                          'CompoundName':table.tableInfo.description,
